    ...
    sidebarLayout(
      sidebarPanel(         
        ...
        conditionalPanel(
          ...
          downloadButton(
            outputId = "downloadSpielErgebnis", label = "Results"
          ),
          
          downloadButton(
            outputId = "downloadProjektBericht", label = "Project report"
          ),
...
{  
  berichtName <<- reactive({
    prefix <- paste0(
      "Young scientist", ifelse(input$female, "in", "")
    )
